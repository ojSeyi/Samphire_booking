...
$emailcheckcommand = "SELECT email FROM customers WHERE email = '$email'";
$emailcheck = mysqli_query($db, $emailcheckcommand);
...
if((mysqli_num_rows($usernamecheck) < 1) || mysqli_num_rows($emailcheck) < 1){
