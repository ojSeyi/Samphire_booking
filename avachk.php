        ...
        <?php
            ...
            <script type='text/javascript' src='JS/global.js'></script>
                    ...
                    if(count($datesinrange) > 31){
                        ...
                        if($k > 0){
                            echo "<br><div id='screen' class='grid-container'><div id='bookingdetail' class='grid-container'><br><br><div id='filled dates' class='grid-container'>The <b>$facility</b> is unavailable on the following dates: <br>";
                            echo "<table><tr>";
                            foreach($unavailabledates as $showdate){
                                echo "<td>".date("d-m-Y",strtotime($showdate))."</td>";
                            }
                            echo "</tr></table></div></div></div>";
                            echo "<form id='search' method='post' action='datecheck2.php'>
